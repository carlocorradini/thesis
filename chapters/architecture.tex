...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/worker.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/controller.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/server.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/database.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/registry.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/cluster_autoscaler.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/load_balancer.png}
\end{wrapfigure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics
  [width=.7\textwidth]{images/architecture/load_balancer_example.png}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/external_network.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/internal_network.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {l}{.2\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/k8s_network.png}
\end{wrapfigure}
...
\begin{wrapfigure}
  {r}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/architecture/overlay_network.png}
  \caption{Comparison
  between
  the
  Physical
