...
\begin{xltabular}
  ...
  admin-username & & admin \\ \hline

  admin-password & & Password\$0 \\ \hline

  airgap & & false \\ \hline

  autoscaler-username & & autoscaler \\ \hline

  autoscaler-password & & Password\$0 \\ \hline

  autoscaler-version & & latest \\ \hline

  bench-time & & 30 \\ \hline

  certs-dir & & configs/certs \\ \hline

  config-file & & configs/recluster/config.yaml \\ \hline
  ...
  k3s-config-file & & configs/k3s/config.yaml \\ \hline

  k3s-registry-config-file & & configs/k3s/registries.yaml \\ \hline

  k3s-version & & latest \\ \hline
  ...
  node-exporter-config-file & & configs/node\_exporter/config.yaml \\ \hline

  node-exporter-version & & latest \\ \hline

  pc-device-api & & http://pc.recluster.local/cm?cmnd=status\%2010 \\ \hline
  ...
  server-env-file & & configs/recluster/server.env \\ \hline
  ...
  ssh-authorized-keys-file & & configs/ssh/authorized\_keys \\ \hline

  ssh-config-file & & configs/ssh/ssh\_config \\ \hline

  sshd-config-file & & configs/ssh/sshd\_config \\ \hline
