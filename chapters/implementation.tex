...
The cpu entity contains information about the CPU\footnote{\url{https://wikipedia.org/wiki/CPU}}
...
that can help determine its performance under various conditions.
...
\begin{itemize}
  ...
  \item \texttt{name}
    ...
    Storage name.
    \newline
    The name of the storage device on the associated node.
    \newline
