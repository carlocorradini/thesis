...
\begin{wrapfigure}
  {l}{.2\textwidth} %
  \centering
  \def\stackalignment{l}\stackunder{ \includegraphics[width=\linewidth]{images/introduction/resource.png} } %
...
\begin{wrapfigure}
  {l}{.2\textwidth} %
  \centering
  \def\stackalignment{l}\stackunder{ \includegraphics[width=\linewidth]{images/logos/open_source.png} } %
