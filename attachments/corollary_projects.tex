...
syntax in the \texttt{GraphQL} query or schema languages\cite{graphql}. \\ %
...
to operate the business logic\cite{graphql}. It is important to note that the context
does not have to follow a predefined structure; rather, it is highly flexible to
...
\begin{xltabular}
  ...
  \begin{itemize}
    \item \texttt{enumName}
      ...
      scalar that is restricted to a particular set of allowed values\cite{graphql}.
      \newline
