...
\definecolor{graphqlRed}{RGB}{228,86,73}
% Code
\usepackage{listings}
...
{ %
keywords={await, typeof, const, let, for, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, class, export, boolean, throw, implements, import, this}, %
...
morekeywords=[2]{ID, String, Int, Float, Boolean, Query, Mutation, Subscription}, %
...
keywordstyle=[5]\color{graphqlRed}, %
morecomment=[l]{\#}, %
morecomment=[s]{"""}{"""}, %
...
\begin{document}
  ...
  \renewcommand{\bibpreamble}{Icons in all Figures, unless otherwise specified, are from \url{www.flaticon.com}. They were created by one or more of the following authors: \texttt{Fathema Khanom}, \texttt{Freepik}, \texttt{Iconpro86}, \texttt{juicy\_fish}, \texttt{Kiranshastry}, \texttt{Pixel perfect}, \texttt{Roundicons}, \texttt{Smashicons}, \texttt{Uniconlab}, \texttt{Vectors Market}, and \texttt{Vitaly Gorbachev}.}
